...
use ContaoCommunityAlliance\Polyfills\Test\Polyfill48\Fixtures\Updater;
use Doctrine\DBAL\Connection;
use PHPUnit\Framework\TestCase;

/**
 * @covers \ContaoCommunityAlliance\Polyfills\Polyfill48\Database\MigrationWrapper
 */
class MigrationWrapperTest extends TestCase
{
    ...
    public function testGetName(): void
    {
        ...
        self::assertSame(
            'ContaoCommunityAlliance\Polyfills\Test\Polyfill48\Fixtures\Updater',
            $wrapper->getName()
        );
    }
